...
@WebMvcTest //여러 스프링 어노테이션 중,Web(Spring MVC)에 집중 할수 있는 어노테이션. 선언시 @Controller,@ControllerAdvice등 사용가능
public class HelloControllerTest { //단@service @Component @Repository등은 사용x 지금은 Comtroller만 사용하기에 사용
        ...
        public void helloDto가_리턴된다() throws Exception{
                ...
                //jsonPath JSON응답값을 필드별로 검증할 수 있는 메소드.$를 기준으로 필드명을 명시.여기서는 name과amount를 검증하니 $.name $.amount로 ㄱㅁ증
        }
}
