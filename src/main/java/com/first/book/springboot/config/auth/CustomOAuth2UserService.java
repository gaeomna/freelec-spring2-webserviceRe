...
import com.first.book.springboot.config.auth.dto.OAuthAttributes;
import com.first.book.springboot.config.auth.dto.SessionUser;
import com.first.book.springboot.domain.user.User;
import com.first.book.springboot.domain.user.UserRepository;
...
: OAuth2 로그인 진행 시 키가 되는 필드값을 이야기 합니다. Primary Key와 같은 의미입니다.
...
SessionUser
: 세션에 사용자 정보를 저장하기 위한 DTO클래스 입니다.
왜 User 클래스를 쓰지 않고 새로 만들어서 쓰는지 위이어서 상세하게 설명하겠습니다.
*/